...
<div class="bla-hero" markdown>
<span class="bla-hero__eyebrow">Theme Docs / Basement LA</span>

# Make changes with confidence.

No code, no guesswork — pick a guide below.
</div>
...
!!! note "Keeping this up to date"
    This site is static and lives in the same GitHub repo as its own source. When a
    feature changes in the theme, update the relevant page here as part of that PR —
    not as a separate "docs day."
